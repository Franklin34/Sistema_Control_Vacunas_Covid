<?php
    ...
    switch($_GET['opc']){
        case 'insert':
            if($paciente->buscarRepetido($_POST['correo']) == false){
        ...
        case 'mod_o_eliminar':
            if(isset($_POST['modificar'])){
                if($paciente->buscarRepetido($_POST['correo']) == true){
                    $paciente->actualizarPaciente($_POST['cedula'],$_POST['nombre'],$_POST['edad'],$_POST['riesgo'],$_POST['genero'],$_POST['telefono']
                    ,$_POST['correo'],$_POST['password'],$_POST['vacuna'],$_POST['dosis']);
                ...
                if($paciente->buscarRepetido($_POST['correo']) == true){
                    $paciente->borrar_paciente($_POST['cedula']);
                    header("Location:".Conectar::ruta()."view/AdministrarPaciente/administrarPaciente.php");
                }
                else{
                    header("Location:".Conectar::ruta()."view/AdministrarPaciente/administrarPaciente.php");
